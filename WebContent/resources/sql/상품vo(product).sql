...
--ALTER TABLE PRODUCT_TBL DROP COLUMN product_price;
--ALTER TABLE PRODUCT_TBL ADD (product_price number(10));
--update PRODUCT_TBL set product_price = 14000;
